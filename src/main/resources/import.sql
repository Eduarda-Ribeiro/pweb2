...
insert into pessoa_juridica (id, razao_social, cnpj, email, telefone, usuario_id) values (3,'Da Casa Produções', '60.485.235/0001-76', 'maria@gmail', '63984836501', 2);
insert into pessoa_fisica (id, nome, cpf, email, telefone, usuario_id) values (2,'Eduarda', '123456789-10', 'eduarda@gmail', '63984895151', 1);
