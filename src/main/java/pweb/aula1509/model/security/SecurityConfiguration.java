...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
                                        .requestMatchers("/pessoaFisica/formPessoaFisica", "/pessoaJuridica/formPessoaJuridica", "/venda/view", "/produtos/list").permitAll()
                                        .requestMatchers("/clientes/list", "venda/list").hasAnyRole("ADMIN")
                                        .requestMatchers("/venda/finalizar").authenticated()
                                        .requestMatchers(HttpMethod.POST,"/pessoaFisica/save", "/pessoaJuridica/save", "/venda/adicionar").permitAll()
                ...
                .formLogin(customizer ->
                        customizer
                                ...
                                .defaultSuccessUrl("/venda/view", true)
                ...
                .logoutSuccessUrl("/login?logout")   // redireciona após sair
                .invalidateHttpSession(true)         // encerra sessão
                .deleteCookies("JSESSIONID")         // apaga cookie
                .permitAll()
                .and()
